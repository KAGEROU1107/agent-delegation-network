...
| WASM SHA-256 (unpinned/fail-closed default) | `8a90dee4b1e45da34e32243c71de0ceccb4f6be9e408a50816c19c0b84afb147` |
...
- digest-derived `delegation_id`; `build_id` emitted in delegate-task output
