...
| Deployment artifact provenance | Partial | `adn-release-proof-v1` manifest finalization with registration response, invocation receipt, T3N evidence digest, replay proof, CI artifact evidence, and remote GitHub artifact verification |
