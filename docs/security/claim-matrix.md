...
- visible CI success exists for the release commit and `ci_release_sha.json` is generated by `.github/workflows/release-proof.yml` after proof-input verification and artifact upload.
